...
export const ASSETS = {
  ...
  pickupSpeed: `${ASSET_BASE}/top-down-tanks/PNG/Retina/specialBarrel2.png`,
  pickupRapidFire: `${ASSET_BASE}/top-down-tanks/PNG/Retina/specialBarrel5.png`,
  pickupShield: `${ASSET_BASE}/top-down-tanks/PNG/Retina/specialBarrel7.png`,
