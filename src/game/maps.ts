...
const AUTHORED_CAMPAIGN_MAPS: CampaignMap[] = [
  ...
  {
    // Blackout Crossing: a night raid lane lit only by tank headlamps and sparse lamp posts.
    id: "map-19",
    name: "Blackout Crossing",
    theme: "night",
    width: 3400,
    height: 2100,
