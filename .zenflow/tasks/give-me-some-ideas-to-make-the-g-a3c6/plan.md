...
### [x] Step: Investigate the current game and its realism levers
- Reviewed the project context and core gameplay files to identify the game as an arcade-style overhead tank game with campaign, deathmatch, co-op, and capture-the-flag concepts.
